...
load("tipestmedianSecSSEcarn.RData")
load("tipestmedianSecSSEceta.RData")
load("tipestmedianSecSSEchiro.RData")
load("tipestmedianSecSSEeuli.RData")
load("tipestmedianSecSSEprim.RData")
load("tipestmedianSecSSErode.RData")
...
svg("fig3median.svg", 18/2.54, 9/2.54, pointsize=8)
