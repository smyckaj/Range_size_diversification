...
orderresult[[6]]=roderesult[[1]]

#load tip state predictions
load("tipestmedianSecSSEall.RData")
load("tipestvarmedianSecSSEcarn.RData")
load("tipestvarmedianSecSSEceta.RData")
load("tipestvarmedianSecSSEchiro.RData")
load("tipestvarmedianSecSSEeuli.RData")
load("tipestvarmedianSecSSEprim.RData")
load("tipestvarmedianSecSSErode.RData")
...
svg("sfvarmedian.svg", 18/2.54, 9/2.54, pointsize=8)
