...
tipstatescarn=bakedrangescarn$above50000+1
...
tipstatesceta=bakedrangesceta$above50000+1
...
tipstateschiro=bakedrangeschiro$above50000+1
...
tipstateseuli=bakedrangeseuli$above50000+1
...
tipstatesprim=bakedrangesprim$above50000+1
...
tipstatesrode=bakedrangesrode$above50000+1
...
save(tipestimatescarn, file="tipest50SecSSEcarn.RData")
...
save(tipestimatesceta, file="tipest50SecSSEceta.RData")
...
save(tipestimateschiro, file="tipest50SecSSEchiro.RData")
...
save(tipstimateseuli, file="tipest50SecSSEeuli.RData")
...
save(tipestimatesprim, file="tipest50SecSSEprim.RData")
