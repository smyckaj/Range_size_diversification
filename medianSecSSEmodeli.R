...
idparslist$lambdas[[3]][3,3]=1

idparslist$lambdas[[4]][,]=0
idparslist$lambdas[[4]][4,4]=2
idparslist$lambdas[[4]][4,3]=3
...
p=starting.point.classe(mamphylo,2)[c(1,6,5,7:10)]
...
geosseislandsbyorders=function(order){
  ...
  idparslistord$lambdas[[3]][3,3]=1
  
  idparslistord$lambdas[[4]][,]=0
  idparslistord$lambdas[[4]][4,4]=2
  idparslistord$lambdas[[4]][4,3]=3
  
  idparslistord$mus[1]=7
  idparslistord$mus[2]=8
  idparslistord$mus[3]=7
  idparslistord$mus[4]=8
  ...
  idparslistord$Q [4,2]=15
  idparslistord$Q [1,3]=15
  idparslistord$Q [3,1]=15
  
  
  
  pord=starting.point.classe(mamphyloord,2)[c(1,6,5,7:10)]
...
save.image("medianSecSSEmodeli.RData")
