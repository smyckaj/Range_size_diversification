...
idparslist$lambdas[[2]][2,2]=1
idparslist$lambdas[[2]][2,1]=0

idparslist$lambdas[[3]][,]=0
idparslist$lambdas[[3]][3,3]=4

idparslist$lambdas[[4]][,]=0
idparslist$lambdas[[4]][4,4]=4
idparslist$lambdas[[4]][4,3]=0
...
p=starting.point.classe(mamphylo,2)[c(1,1,7,8,10,10,10,10)]
fitsecsse=cla_secsse_ml(phy = mamphylo,tipstates, num_concealed_states = num_concealed_states,
                        ...
                        idparsopt = c(1,4,7,9,11,12,15,16),
                        initparsopt= p,
                        idparsfix = 0,
                        parsfix = 0,
...
geosseislandsbyorders=function(order){
  ...
  idparslistord$lambdas[[2]][2,2]=1
  idparslistord$lambdas[[2]][2,1]=0
  
  idparslistord$lambdas[[3]][,]=0
  idparslistord$lambdas[[3]][3,3]=4
  
  idparslistord$lambdas[[4]][,]=0
  idparslistord$lambdas[[4]][4,4]=4
  idparslistord$lambdas[[4]][4,3]=0
  
  idparslistord$mus[1]=7
  idparslistord$mus[2]=7
  idparslistord$mus[3]=9
  idparslistord$mus[4]=9
  ...
  idparslistord$Q [3,4]=11
  idparslistord$Q [4,3]=12
  ...
  pord=starting.point.classe(mamphyloord,2)[c(1,1,7,8,10,10,10,10)]
...
save.image("medianSecSSEmodelii.RData")
