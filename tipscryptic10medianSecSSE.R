...
save(tipestimatescarn, file="tipestcryptic10medianSecSSEcarn.RData")
...
save(tipestimatesceta, file="tipestcryptic10medianSecSSEceta.RData")
...
save(tipestimateschiro, file="tipestcryptic10medianSecSSEchiro.RData")
...
save(tipstimateseuli, file="tipestcryptic10medianSecSSEeuli.RData")
...
save(tipestimatesprim, file="tipestcryptic10medianSecSSEprim.RData")
...
save(tipestimatesrode, file="tipestcryptic10medianSecSSErode.RData")

tipestimatesall=cla_secsse_propab_all(fitsecsse$MLpars,phy=mamphylo, tipstates, mc.cores = cores)
paste("alltogether finished")
save(tipestimatesall, file="tipestcryptic10medianSecSSEall.RData")
