...
load("tipestcryptic30medianSecSSEall.RData")
load("tipestcryptic30medianSecSSEcarn.RData")
load("tipestcryptic30medianSecSSEceta.RData")
load("tipestcryptic30medianSecSSEchiro.RData")
load("tipestcryptic30medianSecSSEeuli.RData")
load("tipestcryptic30medianSecSSEprim.RData")
load("tipestcryptic30medianSecSSErode.RData")
...
svg("sfcryptic30.svg", 18/2.54, 9/2.54, pointsize=8)
