...
load("cryptic30medianSecSSEmodeliii.RData")
...
save(tipestimatescarn, file="tipestcryptic30medianSecSSEcarn.RData")
...
save(tipestimatesceta, file="tipestcryptic30medianSecSSEceta.RData")
...
save(tipestimateschiro, file="tipestcryptic30medianSecSSEchiro.RData")
...
save(tipstimateseuli, file="tipestcryptic30medianSecSSEeuli.RData")
...
save(tipestimatesprim, file="tipestcryptic30medianSecSSEprim.RData")
...
save(tipestimatesrode, file="tipestcryptic30medianSecSSErode.RData")

tipestimatesall=cla_secsse_propab_all(fitsecsse$MLpars,phy=mamphylo, tipstates, mc.cores = cores)
paste("alltogether finished")
save(tipestimatesall, file="tipestcryptic30medianSecSSEall.RData")
