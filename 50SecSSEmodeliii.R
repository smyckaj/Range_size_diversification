...
bakedranges$above50000=as.numeric(50000<bakedranges$area)

#make secsse all
tipstates=bakedranges$above50000+1
...
geosseislandsbyorders=function(order){
  ...
  tipstatesord=bakedrangesord$above50000+1
...
save.image("50SecSSEmodeliii.RData")
