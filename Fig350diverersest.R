...
load("tipest50SecSSEall.RData")
load("tipest50SecSSEcarn.RData")
load("tipest50SecSSEceta.RData")
load("tipest50SecSSEchiro.RData")
load("tipest50SecSSEeuli.RData")
load("tipest50SecSSEprim.RData")
load("tipest50SecSSErode.RData")
...
svg("fig350.svg", 18/2.54, 9/2.54, pointsize=8)
