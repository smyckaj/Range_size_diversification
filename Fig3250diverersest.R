...
load("tipest250SecSSEall.RData")
load("tipest250SecSSEcarn.RData")
load("tipest250SecSSEceta.RData")
load("tipest250SecSSEchiro.RData")
load("tipest250SecSSEeuli.RData")
load("tipest250SecSSEprim.RData")
load("tipest250SecSSErode.RData")

#tipestimatesprim=tipestimatesprim
...
#png(".png",3000,1500,res=300)
svg("fig3250.svg", 18/2.54, 9/2.54, pointsize=8)
